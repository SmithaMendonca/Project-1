                    ...
                    <div class="row">
						<div class="col-md-7 col-sm-6">
							<div class="about-title clearfix">
								<h1>About <span>FashionBazar</span></h1>								
								<p class="about-paddingB">Our vision is to create India's most reliable and frictionless commerce website that creates life-changing experiences for buyers and sellers. </p>
